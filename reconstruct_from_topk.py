...
OUTPUT_TXT = "reconstruction_candidates.txt"
...
def main():
    ...
    pred_text, topk_steps = get_topk_steps(
        model,
        IMAGE_PATH
    )

    candidates = reconstruct_candidates(topk_steps)
    ...
    lines.append("Top-k by position")
    lines.append("-" * 60)
